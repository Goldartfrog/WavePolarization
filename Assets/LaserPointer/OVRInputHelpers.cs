...
namespace ControllerSelection {
    public class OVRInputHelpers {
        ...
        // Find the current active controller, based on last time a certain button was hit. Needs to know the previous active controller.
        public static OVRInput.Controller GetControllerForTouch(OVRInput.Controller oldController)
        {
            OVRInput.Controller controller = OVRInput.GetConnectedControllers();
            ...
            if ((controller & OVRInput.Controller.RTouch) == OVRInput.Controller.RTouch)
            {
                if (OVRInput.Get(OVRInput.Touch.PrimaryIndexTrigger) &&
                    (oldController & controller) == OVRInput.Controller.LTouch)
                {
                    return OVRInput.Controller.LTouch;
                }

                if (OVRInput.Get(OVRInput.Touch.SecondaryIndexTrigger) || oldController == OVRInput.Controller.None)
                {
                    return OVRInput.Controller.RTouch;
                }
            }
            ...
            if ((controller & OVRInput.Controller.LTouch) == OVRInput.Controller.LTouch)
            {
                if (OVRInput.Get(OVRInput.Touch.PrimaryIndexTrigger) || oldController == OVRInput.Controller.None)
                {
                    return OVRInput.Controller.LTouch;
                }
            }
        ...
        public static OVRInput.Handedness GetHandFromController(OVRInput.Controller controller)
        {
            if (controller == OVRInput.Controller.RTouch || controller == OVRInput.Controller.RTrackedRemote)
            {
                return OVRInput.Handedness.RightHanded;
            }

            else if (controller == OVRInput.Controller.LTouch || controller == OVRInput.Controller.LTrackedRemote)
            {
                return OVRInput.Handedness.LeftHanded;
            }

            else
            {
                return OVRInput.Handedness.Unsupported;
            }
        }
    }
}